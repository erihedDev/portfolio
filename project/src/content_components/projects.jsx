        ...
        <div id='projects'>
            ...
            <div className='flex items-center w-full h-40 mt-12'>
                <div className='flex flex-col w-3/5 h-full'>
                    ...
                    <a href={'https://ntig-uppsala.github.io/Frisor-Saxe/personal.html'} className='text-2xl w-64 flex justify-center mt-4 mb-12 p-2 bg-orange-200 rounded-lg hover:bg-orange-300 duration-150 text-black'>Preview project</a>
                </div>
            ...
            <div className='flex items-center w-full h-40 mt-12'>
                <div className='flex flex-col w-3/5 h-full'>
                    ...
                    <a href={'https://ntig-uppsala.github.io/florist-blaklinten/'} className='text-2xl w-64 flex justify-center mt-4 mb-12 p-2 bg-orange-200 rounded-lg hover:bg-orange-300 duration-150 text-black'>Preview project</a>
                </div>
