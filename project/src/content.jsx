        ...
        <div className='flex justify-center w-full'>
            <div className='w-[32rem] h-screen mt-20 text-neutral-50'>
                ...
                <div>
                    ...
                    <div className='flex items-center w-full h-32 mt-12'>
                        <div className='w-1/2'>
                    ...
                    <a href={'https://ntig-uppsala.github.io/Frisor-Saxe/personal.html'} className='text-2xl w-full flex justify-center mt-4 hover:underline underline-offset-2'>Preview project</a>
                    <div className='flex items-center w-full h-32 mt-12'>
                        <div className='w-1/2'>
                            <p className='text-2xl'>Frisör Saxé</p>
                            <p>Website for a hairdresser saloon.</p>
