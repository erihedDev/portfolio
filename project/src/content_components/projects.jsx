    ...
    return (
        <div id='projects' className='mx-4 sm:mx-0'>
            ...
            <div className='flex flex-col-reverse sm:flex-row items-center w-full h-40 mt-48 sm:mt-12'>
                ...
                <img src='assets/images/frisorsaxe.png' alt='image of project for Frisör Saxé' className='w-64 sm:w-2/5 h-40 object-cover rounded-lg'></img>
            </div>
            ...
            <div className='flex flex-col-reverse sm:flex-row items-center w-full h-40 mt-48 sm:mt-12'>
                ...
                <img src='assets/images/floristblaklint.png' alt='image of project for Florist Blåklint' className='w-64 sm:w-2/5 h-40 object-cover rounded-lg'></img>
            </div>
        </div>
    )
}
